...
float calibrationFactor = 500.0; // For every 4.5 pulses, 1 liter of water passes through the sensor per minute.
...
void loop()
{
  ...
  if (currentMillis_wf - previousMillis_wf >= interval) {
    ...
    //Serial.print("pusle: ");
    //Serial.print(pulses);
    //Serial.print("\n");  // Print the flow rate in mL/s with 2 decimal places
